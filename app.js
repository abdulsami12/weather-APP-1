...
axios.get(` https://api.openweathermap.org/data/2.5/weather?units=metric&appid=cddb792ae2c29f173f1d06e0bb7d9a2f&q=${CityName}`)
.then(function (response) {
  // handle success
  console.log(response.data);
  // document.querySelector("#city").innerHTML = `city: ${response.data.name} `
  document.querySelector("#temperature").innerHTML = `${response.data.main.temp } <sup> &deg;</sup> `
  document.querySelector("#feel").innerHTML = `FEELS LIKE ${response.data.main.feels_like}`
